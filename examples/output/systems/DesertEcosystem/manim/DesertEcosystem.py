...
class UltraLinkGraph(Scene):
    def construct(self):
        ...
        # Title
        title = Text("DesertEcosystem Knowledge Graph", color="WHITE")
        ...
        if True:
            conclusion_text = Text(
                f"DesertEcosystem Knowledge Graph Visualization",
                color="WHITE"
            )
            self.play(

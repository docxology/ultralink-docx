# ultralink_model.jl
# Generated by UltraLink on 2025-03-10T17:35:43.174Z
...
@constraints function ultralink_model_constraints()
    ...
    q(pomdp_model, observation_space, state_space, action_space, a_matrix, b_matrix, c_matrix, d_matrix, e_matrix) = q(pomdp_model)q(observation_space)q(state_space)q(action_space)q(a_matrix)q(b_matrix)q(c_matrix)q(d_matrix)q(e_matrix)

    # Distribution family constraints
    q(pomdp_model) :: ExponentialFamily
    q(observation_space) :: ExponentialFamily
    q(state_space) :: ExponentialFamily
    q(action_space) :: ExponentialFamily
    q(a_matrix) :: ExponentialFamily
    q(b_matrix) :: ExponentialFamily
    q(c_matrix) :: ExponentialFamily
    q(d_matrix) :: ExponentialFamily
    q(e_matrix) :: ExponentialFamily
end
# ultralink_model.jl
# Generated by UltraLink on 2025-03-10T17:35:41.044Z
...
function test_ultralink_model()
    ...
    result = infer(
        model = model,
        data = (
            eeg_neurofeedback = rand(Normal(0.0, 1.0)),
            fmri_neurofeedback = rand(Normal(0.0, 1.0)),
            fnirs_neurofeedback = rand(Normal(0.0, 1.0)),
        )
    )

    # Access posterior distributions
    posterior_eeg_neurofeedback = result.posteriors[:eeg_neurofeedback]
    posterior_fmri_neurofeedback = result.posteriors[:fmri_neurofeedback]
    posterior_fnirs_neurofeedback = result.posteriors[:fnirs_neurofeedback]

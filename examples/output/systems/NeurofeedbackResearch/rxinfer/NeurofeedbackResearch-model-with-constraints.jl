# ultralink_model.jl
# Generated by UltraLink on 2025-03-10T19:33:29.918Z
...
@constraints function ultralink_model_constraints()
    ...
    q(eeg_neurofeedback, fmri_neurofeedback, fnirs_neurofeedback, meg_neurofeedback, smr_training, alpha_training, theta_training, beta_training, alpha_theta_training, infra_low_frequency, adhd_treatment, anxiety_treatment, epilepsy_treatment, insomnia_treatment, ptsd_treatment, sterman_mb, lubar_jf, peniston_eg, othmer_sf, eeg_amplifier, eeg_cap, nf_software, sterman_epilepsy_1972, lubar_adhd_1976, peniston_alcoholism_1989, arns_tdcs_2012, operant_conditioning, neuroplasticity, arousal_model) = q(eeg_neurofeedback)q(fmri_neurofeedback)q(fnirs_neurofeedback)q(meg_neurofeedback)q(smr_training)q(alpha_training)q(theta_training)q(beta_training)q(alpha_theta_training)q(infra_low_frequency)q(adhd_treatment)q(anxiety_treatment)q(epilepsy_treatment)q(insomnia_treatment)q(ptsd_treatment)q(sterman_mb)q(lubar_jf)q(peniston_eg)q(othmer_sf)q(eeg_amplifier)q(eeg_cap)q(nf_software)q(sterman_epilepsy_1972)q(lubar_adhd_1976)q(peniston_alcoholism_1989)q(arns_tdcs_2012)q(operant_conditioning)q(neuroplasticity)q(arousal_model)

    # Distribution family constraints
    q(eeg_neurofeedback) :: ExponentialFamily
    q(fmri_neurofeedback) :: ExponentialFamily
    q(fnirs_neurofeedback) :: ExponentialFamily
    q(meg_neurofeedback) :: ExponentialFamily
    q(smr_training) :: ExponentialFamily
    q(alpha_training) :: ExponentialFamily
    q(theta_training) :: ExponentialFamily
    q(beta_training) :: ExponentialFamily
    q(alpha_theta_training) :: ExponentialFamily
    q(infra_low_frequency) :: ExponentialFamily
    q(adhd_treatment) :: ExponentialFamily
    q(anxiety_treatment) :: ExponentialFamily
    q(epilepsy_treatment) :: ExponentialFamily
    q(insomnia_treatment) :: ExponentialFamily
    q(ptsd_treatment) :: ExponentialFamily
    q(sterman_mb) :: ExponentialFamily
    q(lubar_jf) :: ExponentialFamily
    q(peniston_eg) :: ExponentialFamily
    q(othmer_sf) :: ExponentialFamily
    q(eeg_amplifier) :: ExponentialFamily
    q(eeg_cap) :: ExponentialFamily
    q(nf_software) :: ExponentialFamily
    q(sterman_epilepsy_1972) :: ExponentialFamily
    q(lubar_adhd_1976) :: ExponentialFamily
    q(peniston_alcoholism_1989) :: ExponentialFamily
    q(arns_tdcs_2012) :: ExponentialFamily
    q(operant_conditioning) :: ExponentialFamily
    q(neuroplasticity) :: ExponentialFamily
    q(arousal_model) :: ExponentialFamily
end
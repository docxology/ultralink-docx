# ultralink_model.jl
# Generated by UltraLink on 2025-03-10T17:42:19.332Z
...
@constraints function ultralink_model_constraints()
    ...
    q(circulatory_system, respiratory_system, nervous_system, skeletal_system, muscular_system, digestive_system, endocrine_system, immune_system, heart, lungs, brain, liver, kidneys, stomach, intestines, pancreas, spleen, skull, vertebral_column, ribcage, femur, heart_muscle, diaphragm, biceps_brachii, quadriceps, aorta, coronary_arteries, pulmonary_arteries, vena_cava, spinal_cord, vagus_nerve, sciatic_nerve, hypothalamus, neuron, red_blood_cell, cardiomyocyte, epithelial_tissue) = q(circulatory_system)q(respiratory_system)q(nervous_system)q(skeletal_system)q(muscular_system)q(digestive_system)q(endocrine_system)q(immune_system)q(heart)q(lungs)q(brain)q(liver)q(kidneys)q(stomach)q(intestines)q(pancreas)q(spleen)q(skull)q(vertebral_column)q(ribcage)q(femur)q(heart_muscle)q(diaphragm)q(biceps_brachii)q(quadriceps)q(aorta)q(coronary_arteries)q(pulmonary_arteries)q(vena_cava)q(spinal_cord)q(vagus_nerve)q(sciatic_nerve)q(hypothalamus)q(neuron)q(red_blood_cell)q(cardiomyocyte)q(epithelial_tissue)

    # Distribution family constraints
    q(circulatory_system) :: ExponentialFamily
    q(respiratory_system) :: ExponentialFamily
    q(nervous_system) :: ExponentialFamily
    q(skeletal_system) :: ExponentialFamily
    q(muscular_system) :: ExponentialFamily
    q(digestive_system) :: ExponentialFamily
    q(endocrine_system) :: ExponentialFamily
    q(immune_system) :: ExponentialFamily
    q(heart) :: ExponentialFamily
    q(lungs) :: ExponentialFamily
    q(brain) :: ExponentialFamily
    q(liver) :: ExponentialFamily
    q(kidneys) :: ExponentialFamily
    q(stomach) :: ExponentialFamily
    q(intestines) :: ExponentialFamily
    q(pancreas) :: ExponentialFamily
    q(spleen) :: ExponentialFamily
    q(skull) :: ExponentialFamily
    q(vertebral_column) :: ExponentialFamily
    q(ribcage) :: ExponentialFamily
    q(femur) :: ExponentialFamily
    q(heart_muscle) :: ExponentialFamily
    q(diaphragm) :: ExponentialFamily
    q(biceps_brachii) :: ExponentialFamily
    q(quadriceps) :: ExponentialFamily
    q(aorta) :: ExponentialFamily
    q(coronary_arteries) :: ExponentialFamily
    q(pulmonary_arteries) :: ExponentialFamily
    q(vena_cava) :: ExponentialFamily
    q(spinal_cord) :: ExponentialFamily
    q(vagus_nerve) :: ExponentialFamily
    q(sciatic_nerve) :: ExponentialFamily
    q(hypothalamus) :: ExponentialFamily
    q(neuron) :: ExponentialFamily
    q(red_blood_cell) :: ExponentialFamily
    q(cardiomyocyte) :: ExponentialFamily
    q(epithelial_tissue) :: ExponentialFamily
end
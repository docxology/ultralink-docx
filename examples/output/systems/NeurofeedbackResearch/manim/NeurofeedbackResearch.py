...
class UltraLinkGraph(Scene):
    def construct(self):
        ...
        # Title
        title = Text("NeurofeedbackResearch Knowledge Graph", color="WHITE")
        ...
        if "NeurofeedbackResearch" == "USAHistory":
        ...
        elif "NeurofeedbackResearch" == "POMDP":
        ...
        elif "NeurofeedbackResearch" == "Car":
        ...
        if True:
            conclusion_text = Text(
                f"NeurofeedbackResearch Knowledge Graph Visualization",
                color="WHITE"
            )
            self.play(

...
class UltraLinkGraph(Scene):
    def construct(self):
        ...
        # Title
        title = Text("Car Knowledge Graph", color="WHITE")
        ...
        entities = {}
        for entity in [{"id":"sys1","type":"System","name":"Engine System"},{"id":"comp1","type":"Component","name":"Engine Block"},{"id":"comp2","type":"Component","name":"Transmission"}]: 
            color = BLUE
        ...
        for rel in [{"id":"rel1","source":"sys1","target":"comp1","type":"CONTAINS"},{"id":"rel2","source":"comp1","target":"comp2","type":"CONNECTS"}]: 
        ...
        if True:
            conclusion_text = Text(
                f"Car Knowledge Graph Visualization",
                color="WHITE"
            )
            self.play(

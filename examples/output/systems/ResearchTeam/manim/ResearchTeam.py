...
class UltraLinkGraph(Scene):
    def construct(self):
        ...
        # Title
        title = Text("ResearchTeam Knowledge Graph", color="WHITE")
        ...
        if True:
            conclusion_text = Text(
                f"ResearchTeam Knowledge Graph Visualization",
                color="WHITE"
            )
            self.play(

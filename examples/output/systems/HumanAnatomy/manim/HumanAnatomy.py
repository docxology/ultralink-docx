...
class UltraLinkGraph(Scene):
    def construct(self):
        ...
        # Title
        title = Text("HumanAnatomy Knowledge Graph", color="WHITE")
        ...
        if True:
            conclusion_text = Text(
                f"HumanAnatomy Knowledge Graph Visualization",
                color="WHITE"
            )
            self.play(

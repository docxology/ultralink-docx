...
class UltraLinkGraph(Scene):
    def construct(self):
        ...
        # Title
        title = Text("POMDP Knowledge Graph", color="WHITE")
        ...
        entities = {}
        for entity in [{"id":"state1","type":"State","name":"Hidden State"},{"id":"obs1","type":"Observation","name":"Sensor Reading"},{"id":"action1","type":"Action","name":"Control Signal"}]: 
            color = BLUE
        ...
        for rel in [{"id":"rel1","source":"state1","target":"obs1","type":"GENERATES"},{"id":"rel2","source":"action1","target":"state1","type":"AFFECTS"}]: 
        ...
        if True:
            conclusion_text = Text(
                f"POMDP Knowledge Graph Visualization",
                color="WHITE"
            )
            self.play(

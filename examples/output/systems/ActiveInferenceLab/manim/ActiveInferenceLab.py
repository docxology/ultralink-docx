...
class UltraLinkGraph(Scene):
    def construct(self):
        ...
        # Title
        title = Text("ActiveInferenceLab Knowledge Graph", color="WHITE")
        ...
        if "ActiveInferenceLab" == "USAHistory":
        ...
        if True:
            conclusion_text = Text(
                f"ActiveInferenceLab Knowledge Graph Visualization",
                color="WHITE"
            )
            self.play(
